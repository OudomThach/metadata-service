...
def _get_kwargs(
    ...
    *,
    body: RecordPatch,
    x_edited_by: None | str | Unset = UNSET,
    x_api_key: None | str | Unset = UNSET,
    x_session_token: None | str | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}
    if not isinstance(x_edited_by, Unset):
        headers["x-edited-by"] = x_edited_by
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/records/{record_id}".format(
